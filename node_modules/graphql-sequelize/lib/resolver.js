...
function resolverFactory(targetMaybeThunk) {
  ...
  return (() => {
    var _ref = (0, _bluebird.coroutine)(function* (source, args, context, info) {
      let target = typeof targetMaybeThunk === 'function' && !checkIsModel(targetMaybeThunk) ? yield Promise.resolve(targetMaybeThunk(source, args, context, info)) : targetMaybeThunk,
